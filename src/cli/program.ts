...
export const KNOWN_COMMANDS: Set<string> = new Set(['post', 'repost', 'reshare', 'comment', 'search', 'whoami', 'check', 'help']);
	...
	program.addHelpText(
		...
		() =>
			`\n${ctx.colors.section('Examples')}\n${[
				...
				formatExample('slash-linkedin search "looking for crm" --json', 'Search LinkedIn posts'),
